...
require 'partials/bars/_nav.php'; ?>
    ...
    <div class=" bg-light" style="width:auto; padding: 10px; border-radius: 10px;margin:10px auto;">
    <h1 class="text-center my-2">Contact Us</h1>
    <p class="text-center">Have any questions or feedback? We'd love to hear from you.</p><br>
